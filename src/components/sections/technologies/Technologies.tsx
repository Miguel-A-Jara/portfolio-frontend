...
const Technologies = () => {
  ...
  return (
    <div className='min-h-[100vh] flex flex-col gap-4 top-0 py-10
      items-center justify-center px-6 relative text-center bg-black'
    >
      <h3 className='font-bold text-4xl lg:text-7xl text-center dark:text-secondary-400 text-primary-500 w-full max-w-3xl'>
