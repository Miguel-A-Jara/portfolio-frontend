...
const Toggler = ({ isActive, onChange }: Props) => {
  ...
  return (
    <Button
      ...
      dark:bg-secondary-500/25 bg-primary-800/60 hover:dark:bg-secondary-900/50 hover:bg-primary-900/60
    ...
    >
      <div className={`
        ...
        dark:bg-secondary-400 bg-primary-500 dark:text-secondary-900 text-primary-800
